...
|---|------|----------|------|------|----------|
| **第一阶段：循环** |
| 1 | s01 - Agent Loop | AI 模型如何从"只能说话"变成"能做事"？ | ⬜ 未开始 | [→](phase1-the-loop/s01-agent-loop.md) | — |
...
| 阶段二 | 规划 + 隔离 + 知识加载 + 压缩 | ⬜ 未开始 | [→](review/phase2-review.md) |
| 阶段三 | 任务持久化 + 异步执行 | ⬜ 未开始 | [→](review/phase3-review.md) |
